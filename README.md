...
- `4.0.0-beta.1-1` [(4.0.0-beta.1-1/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/4.0.0-beta.1-1/Dockerfile)
- `4.0.0-beta.1-1-alpine` [(4.0.0-beta-alpine/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/4.0.0-beta.1-1/alpine/Dockerfile)
...
```sh
docker run -it --rm -p 8444.0.0-beta443 wiremock/wiremock --https-port 8443 --verbose
```
