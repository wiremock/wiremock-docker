...
- `3.4.1-2` [(3.4.1-2/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.4.1-2/Dockerfile)
- `3.4.1-2-alpine` [(3.4-alpine/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.4.1-2/alpine/Dockerfile)
