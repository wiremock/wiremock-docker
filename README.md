...
- `3.7.0-1` [(3.7.0-1/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.7.0-1/Dockerfile)
- `3.7.0-1-alpine` [(3.7-alpine/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.7.0-1/alpine/Dockerfile)
