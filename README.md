...
- `3.6.0-1` [(3.6.0-1/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.6.0-1/Dockerfile)
- `3.6.0-1-alpine` [(3.6-alpine/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.6.0-1/alpine/Dockerfile)
