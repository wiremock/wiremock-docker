...
- `3.8.0-1` [(3.8.0-1/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.8.0-1/Dockerfile)
- `3.8.0-1-alpine` [(3.8-alpine/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.8.0-1/alpine/Dockerfile)
