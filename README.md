...
<strong>WireMock open source is supported by <a href="https://www.wiremock.io/cloud-overview?utm_source=github.com&utm_campaign=wiremock-docker-README.md-banner">WireMock Cloud</a>. Please consider trying it out if your team needs to collaborate on cloud-hosted mocks with advanced capabilities such as OpenAPI, dynamic state, data sources and more.</strong>
</td>
</tr>
</table>
...
- `3.13.2-2` [(3.13.2-2/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.13.2-2/Dockerfile)
- `3.13.2-2-alpine` [(3.13-alpine/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.13.2-2/alpine/Dockerfile)
