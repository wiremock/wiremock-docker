...
- `3.2.0-1` [(3.2.0-1/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.2.0-1/Dockerfile)
- `3.2.0-1-alpine` [(3.2-alpine/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.2.0-1/alpine/Dockerfile)
...
- `3.2.0-1 [(3.2/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.2.0-1/Dockerfile)
- `3.2.0-1-alpine` [(3.2-alpine/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.2.0-1/alpine/Dockerfile)
