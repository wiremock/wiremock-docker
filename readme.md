...
- `3.1.0-1` [(3.1.0-1/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.1.0-1/Dockerfile)
- `3.1.0-1-alpine` [(3.1-alpine/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.1.0-1/alpine/Dockerfile)
...
- `3.1.0-1 [(3.1/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.1.0-1/Dockerfile)
- `3.1.0-1-alpine` [(3.1-alpine/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/3.1.0-1/alpine/Dockerfile)
