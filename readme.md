...
- `2.16.0`, `latest` [(2.16/Dockerfile)](https://github.com/rodolpheche/wiremock-docker/blob/2.16.0/Dockerfile)
- `2.16.0-alpine` [(2.16-alpine/Dockerfile)](https://github.com/rodolpheche/wiremock-docker/blob/2.16.0/alpine/Dockerfile)
