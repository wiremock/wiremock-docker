...
- `2.32.0-1`, `latest` [(2.32/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/2.32.0-1/Dockerfile)
- `2.32.0-1-alpine`, `latest-alpine` [(2.32-alpine/Dockerfile)](https://github.com/wiremock/wiremock-docker/blob/2.32.0-1/alpine/Dockerfile)
